...
#include "si7021.h"	// temperature + humidity sensor
#include "soil.h"	// soil temperature + capacitance sensor
...
int main(void)
{
  ...
  // Testing the soil sensor address
  ...
  while (1)
  {
	...
	printf("AirRH: %.2f %%  AirTemp: %.2f C | SoilCap: %u  SoilTemp: %.2f C\r\n", hum_air, temp_air, cap_soil, temp_soil);
